...
import ru.scorpio92.vkmd.Receivers.HeadsetPlugReceiver;
import ru.scorpio92.vkmd.Receivers.LockScreenReceiver;
...
public class AudioService extends Service implements AudioManager.OnAudioFocusChangeListener {
    ...
    public final static String BROADCAST_ACTION = "ru.scorpio92.vkmd.View.MusicListFooterFragment";
    ...
    public final static String NOTIFICATION_ACTION_PREV = "ru.scorpio92.vkmd.Services.AudioService.PREV";
    public final static String NOTIFICATION_ACTION_PLAY_PAUSE = "ru.scorpio92.vkmd.Services.AudioService.PLAY_PAUSE";
    public final static String NOTIFICATION_ACTION_NEXT = "ru.scorpio92.vkmd.Services.AudioService.NEXT";
    public final static String NOTIFICATION_ACTION_STOP = "ru.scorpio92.vkmd.Services.AudioService.STOP";
