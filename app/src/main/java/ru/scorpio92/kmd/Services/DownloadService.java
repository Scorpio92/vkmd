...
import ru.scorpio92.kmd.View.DownloadManagerActivity;
...
public class DownloadService extends IntentService {
    ...
    public static final String DEFAULT_DOWNLOAD_FOLDER = "kmd";
    ...
    public final static String BROADCAST_ACTION = "ru.scorpio92.kmd.View.MainActivity";
    ...
    public final static String NOTIFICATION_ACTION_PLAY_PAUSE = "ru.scorpio92.kmd.Services.DownloadService.PLAY_PAUSE";
    public final static String NOTIFICATION_ACTION_STOP = "ru.scorpio92.kmd.Services.DownloadService.STOP";
    public final static String NOTIFICATION_ACTION_RESCAN = "ru.scorpio92.kmd.Services.DownloadService.RESCAN";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            File kmdFolder = new File(downloadPath);
            if (!kmdFolder.exists()) {
                if(kmdFolder.mkdir())
